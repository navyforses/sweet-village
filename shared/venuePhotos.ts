/**
 * Raw photo references for every picture the public site renders. This file
 * is the compile-time default for the owner-editable content model, so it
 * must stay free of client-only imports (the browser resolves refs through
 * `client/src/lib/assetUrl.ts`; the API reads them as plain strings).
 *
 * `/manus-storage/...` refs are legacy paths rewritten to the Vercel Blob
 * origin at runtime; `/events/...` and `/pool-view-house/...` live in
 * `client/public`. Owner uploads are absolute Blob URLs.
 */

/** Generated scenery and real Facebook photographs used by inner pages. */
export const RAW_PHOTOS = {
...
/** Homepage imagery: only real venue photography and approved cottage images. */
export const HOME_PHOTO_REFS = {
  hero: "/pool-view-house/homepage-cover-wide-2026.webp",
  ...
  cottageBedroom: "/manus-storage/large-cottage-ground-floor-bedroom-approved.webp",
  cottageStudio: "/manus-storage/garden-cottage-studio.webp",
} as const;

export const HOME_GALLERY_REFS = [
  "/events/real-12.jpg",
  "/events/real-10.jpg",
...
/** Events overview page hero and the "real space" strip (Phase 2 defaults). */
export const EVENTS_PAGE_HERO = "/events/00-events-overview.webp";
export const EVENTS_SPACE_PHOTO_REFS = [
  "/events/real-11.jpg",
  "/events/real-10.jpg",
  "/events/real-07.jpg",
  "/events/real-15.jpg",
...
export const RAW_DISHES: Record<string, string> = {
...
export const RAW_MENU_ITEM_PHOTOS: Record<number, string> = {
