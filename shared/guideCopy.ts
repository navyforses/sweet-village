/**
 * Seed articles for the "Guides" section: practical, search-friendly pages
 * about the places guests come here for. Georgian and English are written;
 * the other languages start empty and are filled from the admin panel
 * ("Translate" button) or by hand. Facts such as ticket prices change, so
 * the texts give ranges and point to the official sources.
 */
