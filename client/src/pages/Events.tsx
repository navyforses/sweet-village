  ...
  return (
    <div>
      <div className="relative h-[54svh] min-h-[22rem] max-h-[35rem] overflow-hidden md:h-[58vh] md:min-h-[24rem] md:max-h-[44rem]">
        ...
        <div className="relative flex size-full items-end pb-8 md:pb-14 [text-shadow:0_1px_14px_rgba(20,28,24,0.58)]">
          <div className="container">
            <p className="sv-eyebrow mb-4 w-fit text-white">
              {t.events.eyebrow}
            </p>
            <h1 className="max-w-[24ch] text-[clamp(1.8rem,8vw,3.4rem)] leading-[1.12] text-white">
              {t.events.title}
            </h1>
            <p className="mt-4 max-w-[58ch] text-[0.875rem] leading-6 text-white/90 md:mt-5 md:text-[0.94rem] md:leading-7">
              {t.events.intro}
            </p>
          </div>
        </div>
      ...
      <main className="container py-10 md:py-20">
        <section className="grid gap-7 border-b border-line pb-9 lg:grid-cols-[1fr_auto] lg:items-end lg:pb-12">
          <div>
          ...
          <dl className="grid grid-cols-2 gap-5 border-s-2 border-gold/40 ps-5 md:gap-8 md:ps-8">
            <div>
        ...
        <aside className="mt-12 border border-gold/40 bg-gold/[0.06] p-5 sm:p-7 md:mt-16 md:p-9">
