const fr = {
  ...
  "stay": {
    ...
    "units": {
      "small-a": {
        "title": "Petit cottage I",
        "body": "Cottage en bois indépendant dans le jardin, espace lumineux unique, deux lits. Canapé-lit pour jusqu'à quatre personnes. Idéal pour un couple ou une petite famille."
      },
      "small-b": {
