...
export const AUTHENTIC_COPY: Record<LocaleCode, LocalePatch> = {
  ...
  en: {
    ...
    services: { title: "What awaits you here", subtitle: "Relaxation, a feast, and a day that turns into a memory", events: { body: "A birthday, civil ceremony, wedding, or simply a beautiful evening — complete with a feast, garden, and covered space." }, pool: { body: "A summer day by the pool, surrounded by greenery and peace — with family, friends, or just for yourself." }, restaurant: { body: "Home-cooked Georgian dishes, an Imeretian feast, ketsi, and clay pots." }, stay: { body: "Five accommodation units in a green yard — for couples, families, and groups of friends." } },
    stay: { intro: "Five accommodation units in a green yard. Couples, families, and friends travelling around Tskaltubo and Imereti stay here. There are 17 beds in total, and room for up to 22 guests with pull-out sofas." },
  ...
  ru: {
    ...
    services: { title: "Что вас ждёт у нас", subtitle: "Отдых, застолье и день, который остаётся в памяти", events: { body: "День рождения, роспись, свадьба или просто прекрасный вечер — с застольем, садом и крытой площадкой." }, pool: { body: "Летний день у бассейна, в зелени и тишине — с семьёй, друзьями или просто для себя." }, restaurant: { body: "Домашние грузинские блюда, имеретинское застолье, кеци и глиняные горшочки." }, stay: { body: "Пять вариантов размещения в зелёном дворе — для пары, семьи и компании друзей." } },
    stay: { intro: "Пять вариантов размещения в зелёном дворе. Здесь останавливаются пары, семьи и друзья, путешествующие по Цхалтубо и Имеретии. Всего 17 спальных мест, а с раскладными диванами — до 22 гостей." },
  ...
  ar: {
    ...
    services: { title: "ما ينتظركم معنا", subtitle: "استرخاء، ومائدة، ويوم يبقى في الذاكرة", events: { body: "عيد ميلاد، حفل زفاف، أو ببساطة أمسية جميلة — مع مائدة، وحديقة، ومساحة مغطاة." }, pool: { body: "يوم صيفي بجانب المسبح، وسط الخضرة والهدوء — مع العائلة، الأصدقاء، أو بمفردكم للاسترخاء." }, restaurant: { body: "أطباق جورجية محضرة عائلياً، مائدة إيميريتي، كيتسي وأوانٍ فخارية." }, stay: { body: "خمس وحدات سكنية في حديقة خضراء — للأزواج، والعائلات، ومجموعات الأصدقاء." } },
    stay: { intro: "خمس وحدات سكنية في حديقة خضراء. يقيم هنا الأزواج والعائلات والأصدقاء الذين يستكشفون تسكالتوبو ومنطقة إيميريتي. إجمالي عدد الأسرة 17، ومع الأرائك القابلة للطي يتسع المكان حتى 22 ضيفاً." },
  ...
  es: {
    ...
    services: { title: "Qué te espera con nosotros", subtitle: "Descanso, comida y un día que queda en el recuerdo", events: { body: "Cumpleaños, ceremonia civil, boda o simplemente una hermosa tarde — con comida, jardín y espacio cubierto." }, pool: { body: "Un día de verano junto a la piscina, entre verdor y en un entorno tranquilo — con la familia, amigos o simplemente para ti." }, restaurant: { body: "Platos georgianos preparados en familia, mesa de Imereti, ketsi y olla de arcilla." }, stay: { body: "Cinco unidades de alojamiento en un patio verde — para parejas, familias y grupos de amigos." } },
    stay: { intro: "Cinco unidades de alojamiento en un patio verde. Aquí se hospedan parejas, familias y amigos que viajan por Tskaltubo e Imereti. Hay un total de 17 camas, y hasta 22 huéspedes con los sofás cama." },
