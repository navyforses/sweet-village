...
export const AUTHENTIC_COPY: Record<LocaleCode, LocalePatch> = {
  ka: {
    ...
    stay: { eyebrow: "კოტეჯები და ნომრები", title: "აირჩიეთ თქვენი კოტეჯი ან ნომერი", intro: "ხუთი საცხოვრებელი ერთეული მწვანე ეზოში. აქ რჩებიან წყვილები, ოჯახები და მეგობრები, რომლებიც წყალტუბოსა და იმერეთის გარშემო მოგზაურობენ. სულ 17 საწოლია, გასაშლელი დივნებით კი 22 სტუმრამდე." },
  ...
  en: {
    ...
    stay: { eyebrow: "Cottages & rooms", title: "Choose your cottage or room", intro: "Five accommodation units in a green yard. Couples, families, and friends travelling around Tskaltubo and Imereti stay here. There are 17 beds in total, and room for up to 22 guests with pull-out sofas." },
  ...
  ru: {
    ...
    stay: { eyebrow: "Коттеджи и номера", title: "Выберите свой коттедж или номер", intro: "Пять вариантов размещения в зелёном дворе. Здесь останавливаются пары, семьи и друзья, путешествующие по Цхалтубо и Имеретии. Всего 17 спальных мест, а с раскладными диванами — до 22 гостей." },
  ...
  ar: {
    ...
    stay: { eyebrow: "الأكواخ والغرف", title: "اختر الكوخ أو الغرفة المناسبة لك", intro: "خمس وحدات سكنية في حديقة خضراء. يقيم هنا الأزواج والعائلات والأصدقاء الذين يستكشفون تسكالتوبو ومنطقة إيميريتي. إجمالي عدد الأسرة 17، ومع الأرائك القابلة للطي يتسع المكان حتى 22 ضيفاً." },
  ...
  fr: {
    ...
    stay: { eyebrow: "Chalets & chambres", title: "Choisissez votre chalet ou votre chambre", intro: "Cinq unités d'hébergement dans une cour verdoyante. Couples, familles et amis en voyage autour de Tskaltubo et de l'Iméréthie y trouvent refuge. Il y a 17 lits au total, et jusqu'à 22 invités avec les canapés-lits." },
  ...
  es: {
    ...
    stay: { eyebrow: "Cabañas y habitaciones", title: "Elige tu cabaña o habitación", intro: "Cinco unidades de alojamiento en un patio verde. Aquí se hospedan parejas, familias y amigos que viajan por Tskaltubo e Imereti. Hay un total de 17 camas, y hasta 22 huéspedes con los sofás cama." },
